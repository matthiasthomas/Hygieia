...
// TODO: Avoid catching NullPointerException; consider removing the cause of the
// NPE
public final class Encryption {
	...
	public static String getStringKey() throws EncryptionException {
		...
		try {
			...
			ApplicationDBLogger.log(HygieiaConstants.CORE,
					"Encryption.getStringKey", "Cannot generate a secret key"
							+ '\n' + e.getMessage(), e);
	...
	public static SecretKey getSecretKey() throws EncryptionException {
		...
		try {
			...
			ApplicationDBLogger.log(HygieiaConstants.CORE,
					"Encryption.getSecretKey", "Cannot generate a secret key"
							+ '\n' + e.getMessage(), e);
			throw new EncryptionException("Cannot generate a secret key" + '\n'
					+ e.getMessage());
		}
	...
	public static String encryptString(String message, SecretKey key)
		...
		try {
			...
			ApplicationDBLogger.log(HygieiaConstants.CORE,
					...
					"Cannot encrypt this message : " + e.getMessage(), e);
	...
	public static String decryptString(String encryptedMessage, SecretKey key)
		...
		try {
			...
			ApplicationDBLogger.log(HygieiaConstants.CORE,
					...
					"Cannot decrypt this message : " + e.getMessage(), e);
	...
	public static void main(String[] args) {
		try {
			...
			System.out
					.println("Sample encrypted string with the above key for 'thisIsMyPassword' is:");
